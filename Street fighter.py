...
class Background(pygame.sprite.Sprite):
    ...
    def end_round_count(self):
        if pygame.time.get_ticks() - self.end_round_time >= TICK:
            self.round_count -= 1
            self.last_end_time = pygame.time.get_ticks()
    ...
    if background.game_over is False:
        if background.round_over is False:
            if fighter_1.alive is False:
                fighter_2.score += 1
                background.round_over = True
                background.end_round_time = pygame.time.get_ticks()
            ...
            if pygame.time.get_ticks() - background.end_round_time >= ROUND_CD:
                background.round_over = False
                background.map += 1
                if background.map == 4:
                    background.game_over = True
                fighter_1 = Fighter(1, 150, 500,
                                    ...
                                    False, sword, [180, 2.3, 3, [78, 56]],
                                   [pygame.K_w, pygame.K_a, pygame.K_d,
                                    pygame.K_c, pygame.K_LSHIFT], fighter_1.score)
                fighter_2 = Fighter(2, 1050, 500,
                                    martial_sheet, MARTIAL_ANIMATIONS,
                                    True, sword, [200, 2.5, 3.5, [80, 77]],
                                    [pygame.K_KP8, pygame.K_KP4, pygame.K_KP6,
                                        pygame.K_KP_ENTER, pygame.K_LEFT], fighter_2.score)
